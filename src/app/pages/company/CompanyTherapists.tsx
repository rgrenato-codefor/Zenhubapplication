...
export default function CompanyTherapists() {
  ...
  const handleSearchTherapist = async () => {
    ...
    if (!query) {
      setInviteError("Digite o @username ou código do profissional.");
      return;
    }
    ...
    if (companyTherapistIds.includes(found.id)) {
      setInviteError("Este profissional já faz parte da sua equipe.");
      return;
    }
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-amber-200 shadow-sm overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-amber-100 bg-amber-50">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-amber-600">
                Profissionais aguardando sua aprovação para integrar a equipe
              </p>
            </div>
          </div>
          <div className="divide-y divide-gray-50">
            {pendingRequests.map((req) => {
              ...
              const name    = fullTherapist?.name    ?? req.therapistName    ?? "Profissional";
      ...
      {companyTherapists.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-xl border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-500 text-sm" style={{ fontWeight: 600 }}>Nenhum profissional encontrado</p>
          <p className="text-gray-400 text-xs mt-1">Use "Associar Profissional" para convidar pelo username.</p>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            ...
            <div className="px-6 pt-6 pb-4 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-gray-900 text-sm" style={{ fontWeight: 700 }}>Associar Profissional</h3>
                  <p className="text-gray-400 text-xs">
                    {addStep === "search" ? "Informe o @username ou código do profissional" : "Confirme os dados antes de associar"}
                  </p>
                </div>
              </div>
                ...
                <>
                  <div>
                    <label className="block text-xs text-gray-500 mb-1.5" style={{ fontWeight: 600 }}>
                      Username ou código do profissional *
                    </label>
                    <div className="relative">
                  ...
                  <div className="flex gap-3 pt-1">
                     ...
                     >
                       {searching
                         ...
                         : <><Search className="w-4 h-4" /> Buscar profissional</>}
                     </button>
                   </div>
                </>
              )}
                ...
                <>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center gap-2 mt-3 px-3 py-2 rounded-lg bg-emerald-50 border border-emerald-100">
                        ...
                        <p className="text-xs text-emerald-700" style={{ fontWeight: 600 }}>
                          Profissional identificado — confirme os dados antes de associar
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2 p-3 rounded-xl bg-gray-50">
                      <div className="flex-1 text-center">
                        <p className="text-xs text-gray-400">Profissional recebe</p>
                  ...
                  <div className="p-3 bg-amber-50 rounded-xl border border-amber-100">
                    ...
                    <p className="text-amber-600 text-xs mt-0.5 leading-relaxed">
                      Ao associar o profissional, <strong>os preços da empresa passam a valer</strong> para todos os atendimentos.
                      Os preços pessoais do profissional ficam suspensos durante o vínculo.
                    </p>
                  </div>
      ...
      {modal === "approve" && selectedId && (() => {
        ...
        const name = fullT?.name ?? req?.therapistName ?? "Profissional";
            ...
            <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
              <div className="px-6 pt-6 pb-4 border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 text-sm" style={{ fontWeight: 700 }}>Aprovar Profissional</h3>
